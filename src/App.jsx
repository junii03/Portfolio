    ...
    return (
        <ReactLenis root className='relative w-screen min-h-screen overflow-x-auto'>
            {!isReady && <div className='fixed inset-0 z-[999] flex flex-col items-center justify-center bg-black text-white transition-opacity duration-700 font-light'>
                ...
                <div className='relative h-1 w-60 bg-white/20 overflow-hidden rounded'>
                    <div className='absolute top-0 left-0 h-full transition-all duration-300 bg-white animate-progress' style={{ width: `${progress}%` }}>
